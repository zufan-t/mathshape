      ...
      >
        ...
        <div style={{
          ...
          <h1 style={{
            ...
            color: '#34393F', textAlign: 'center', marginBottom: '8px',
          }}>Masuk</h1>
          <p style={{
            fontFamily: 'var(--font-body)', fontSize: '16px', color: '#6B7280',
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }} noValidate>
            ...
            <div>
              ...
              <input
                ...
                onBlur={e => { handleEmailBlur(); if (!emailError) e.target.style.borderColor = '#E5E7EB' }}
              />
              {emailError && (
              ...
              <div style={{ position: 'relative' }}>
                <input
                  ...
                  style={{
                    ...
                    border: '1.5px solid #E5E7EB', backgroundColor: '#F0F2F8',
                    fontFamily: 'var(--font-body)', fontSize: '16px', color: '#34393F',
          ...
          <p style={{ fontFamily: 'var(--font-body)', fontSize: '14px', color: '#6B7280', textAlign: 'center', marginTop: '20px' }}>
            Belum punya akun?{' '}
            <Link to={ROUTES.REGISTER} style={{ color: '#007BFF', fontWeight: 600 }}>Daftar di sini</Link>
          </p>
        </div>
      </motion.div>
    </div>
