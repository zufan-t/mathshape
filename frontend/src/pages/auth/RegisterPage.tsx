...
export default function RegisterPage() {
  ...
  const isTeacherPage = location.pathname === ROUTES.TEACHER_REGISTER
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Determine role based on which registration page they are signing up on
    const userRole = isTeacherPage ? 'teacher' : 'student'
      ...
      >
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }} noValidate>
            ...
            <div>
              ...
              <div style={{ position: 'relative' }}>
                <input
                  ...
                  onBlur={e => { if (!passwordError) e.target.style.borderColor = 'var(--color-border)' }}
                />
            ...
            <div>
              ...
              <div style={{ position: 'relative' }}>
                <input
                  ...
                  onBlur={e => { if (!confirmError) e.target.style.borderColor = 'var(--color-border)' }}
                />
            ...
            <p style={{ fontFamily: 'var(--font-body)', fontSize: '14px', color: 'var(--color-text-light)', textAlign: 'center', margin: 0 }}>
              Sudah punya akun?{' '}
              <Link to={isTeacherPage ? ROUTES.TEACHER_LOGIN : ROUTES.LOGIN} style={{ color: '#007BFF', fontWeight: 600 }}>Masuk di sini</Link>
            </p>
