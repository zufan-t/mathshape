...
export default function Button({
  ...
  const variantStyle: Record<string, React.CSSProperties> = {
    ...
    outline: { backgroundColor: 'var(--button-outline-bg, #ffffff)', color: 'var(--button-outline-text, #000000)', border: '1.5px solid var(--button-outline-border, #000000)' },
  ...
  const hoverAnimation: Record<string, object> = {
    ...
    outline: { backgroundColor: 'var(--button-outline-hover-bg, #000000)', color: 'var(--button-outline-hover-text, #ffffff)' },
